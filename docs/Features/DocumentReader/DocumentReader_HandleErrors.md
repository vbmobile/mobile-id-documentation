...
=== "Android"
    ...
    Example can be found here: [DocumentReaderHandleErrors](https://github.com/vbmobile/mobileid-android-sample/tree/main/app/src/main/java/com/example/sample_app_android/presentation/readDocument/DocumentReaderActivity.kt)
    ```kotlin
